...
Function CreateCategories()
    ...
    Category = CreatePosterItem("npr","Mormon Channel","Talk Radio Station")
    Category.Process = DoNpr
    aa.PosterItems.push(Category)

    Category = CreatePosterItem("mp3","Music","Musical Radio Station")
    Category.Process = DoMp3
    aa.PosterItems.push(Category)

    Category = CreatePosterItem("wma","Canal Mormón","Spanish/Español")
    Category.Process = DoWma
    aa.PosterItems.push(Category)
	
	Category = CreatePosterItem("wma2","Mormon Tabernacle Choir","Tabernacle Choir Radio Station")
    Category.Process = DoWma2
    aa.PosterItems.push(Category)
